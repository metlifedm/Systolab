  ...
  return (
    <section className="py-24" style={{ background: '#0A0A0F' }}>
      <div className="container-custom">
        ...
        >
          <p className="font-mono text-xs tracking-widest uppercase mb-4" style={{ color: 'rgba(255,255,255,0.2)' }}>
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-4">
          {clients.map((c, i) => (
            ...
            >
              ...
              <span className="text-xs text-center leading-tight" style={{ color: 'rgba(255,255,255,0.3)' }}>
                {c.name}
              </span>
            </motion.div>
          ))}
