    ...
    >
        ...
        {['847%', '8.7x', '$5B+', '200+', '98%', '+340%'].map((n, i) => (
          <motion.div
            ...
            style={{
              ...
              color: i % 2 === 0 ? 'rgba(26,74,122,0.04)' : 'rgba(44,110,73,0.04)',
      ...
      <div className="relative z-10 container-custom text-center" ref={ref}>
        ...
        >
          ...
          <span className="block text-white">don't lie.</span>
        ...
        >
          {verifications.map((v) => (
            <div key={v} className="flex items-center gap-2">
              ...
              <span className="text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>{v}</span>
            </div>
          ))}
        </motion.div>
